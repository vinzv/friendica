<div class="generic-page-wrapper">
	...
	<form action="settings/oauth" method="post" autocomplete="off">
		...
		<div class='oauthapp'>
			...
			{{/if}}
			{{if $app.my}}
			<a href="{{$baseurl}}/settings/oauth/edit/{{$app.client_id}}" class="btn" title="{{$edit}}"><i class="far fa-edit" aria-hidden="true"></i>&nbsp;</a>
			<a href="{{$baseurl}}/settings/oauth/delete/{{$app.client_id}}?t={{$form_security_token}}" class="btn" title="{{$delete}}"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>
			{{/if}}
		</div>
		{{/foreach}}
