...
function frio_form($arr)
{
	...
	$ctx = [
		...
		'$navbg_left'      => array_key_exists('navbg_left', $disable) ? '' : ['navbg_left', L10n::t('Navigation bar gradient background color (left)'), $arr['navbg_left'], '', false],
		'$navbg_middle'    => array_key_exists('navbg_middle', $disable) ? '' : ['navbg_middle', L10n::t('Navigation bar gradient background color (middle)'), $arr['navbg_middle'], '', false],
		'$navbg_right'     => array_key_exists('navbg_right', $disable) ? '' : ['navbg_right', L10n::t('Navigation bar gradient background color (right)'), $arr['navbg_right'], '', false],
